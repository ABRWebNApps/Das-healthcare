...
<head>
  ...
  <title>Appointment Confirmed - DAS Healthcare</title>
</head>
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td align="center" style="padding:20px 40px;background-color:#f0fdf4;border-bottom:1px solid #dcfce7;">
              <p style="margin:0;color:#166534;font-size:18px;font-weight:bold;">✅ Appointment Confirmed!</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 40px;">
              ...
              <p style="margin:0 0 24px;color:#6b7280;font-size:15px;line-height:1.7;">
                Your appointment with DAS Healthcare has been reviewed and <strong>confirmed</strong>. We look forward to seeing you. Please review your appointment details below.
              </p>
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="padding:8px 0;border-bottom:1px solid #e2e8f0;">
                          <span style="color:#6b7280;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">📅 Date</span>
                          <p style="margin:4px 0 0;color:#111827;font-size:15px;font-weight:600;">${formattedDate}</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:8px 0;border-bottom:1px solid #e2e8f0;">
                          <span style="color:#6b7280;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">🕐 Time</span>
              ...
              <p style="margin:0 0 8px;color:#6b7280;font-size:14px;line-height:1.7;">
                If you need to reschedule or cancel, please contact us at least <strong>24 hours</strong> in advance.
              </p>
